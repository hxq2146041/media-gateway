...
bool GetUInt64FromJson(const Json::Value& in, uint64_t* out) {
  bool ret = false;
  if (in.isUInt64()) {
		ret = true;
      *out = in.asUInt64();
...
bool GetInt64FromJson(const Json::Value& in, int64_t* out) {
  bool ret = false;
  if (in.isInt64()) {
		ret = true;
      *out = in.asInt64();
...
bool GetUInt64FromJsonObject(const Json::Value& in,
                             const std::string& k,
                             uint64_t* out) {
  Json::Value x;
  return GetValueFromJsonObject(in, k, &x) && GetUInt64FromJson(x, out);
}
...
bool GetInt64FromJsonObject(const Json::Value& in,
                          const std::string& k,
                          int64_t* out)
{
  Json::Value x;
  return GetValueFromJsonObject(in, k, &x) && GetInt64FromJson(x, out);
}
